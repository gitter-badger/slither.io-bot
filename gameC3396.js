...
var oef = function() {
        ...
        for (u = preys.length - 1; 0 <=
            ...
            w.gfr += vfr * w.gr;
            w.eaten ? (1.5 != w.fr && (w.fr += vfr / 150, 1.5 <= w.fr && (w.fr = 1.5)), w.eaten_fr += vfr / 47, w.gfr += vfr, e = w.eaten_by, 1 <= w.eaten_fr || !e ? preys.splice(u, 1) : (w.eaten_fr4 = Math.pow(w.eaten_fr, 4), w.rad = 1 - Math.pow(w.eaten_fr, 3))) : 1 != w.fr && (w.fr += vfr / 150, 1 <= w.fr ? (w.fr = 1, w.rad = 1) : (w.rad = .5 * (1 - Math.cos(Math.PI * w.fr)), w.rad += .66 * (.5 * (1 - Math.cos(Math.PI *
                w.rad)) - w.rad)))
        }
        for (u = cm1 = foods_c - 1; 0 <= u; u--) b = foods[u], b.gfr += vfr * b.gr, b.eaten ? (1.5 != b.fr && (b.fr += vfr / 150, 1.5 <= b.fr && (b.fr = 1.5)), b.eaten_fr += vfr / 41, b.rad = 1 - Math.pow(b.eaten_fr, 3), e = b.eaten_by, 1 <= b.eaten_fr || !e ? (u == cm1 ? foods[u] = null : (foods[u] = foods[cm1], foods[cm1] = null), foods_c--, cm1--) : (e = b.eaten_by, f = b.eaten_fr * b.eaten_fr, b.eaten_fr4 = f * f, b.rad = 1 - b.eaten_fr * f, b.rx = b.xx + (e.xx + e.fx + Math.cos(e.ang + e.fa) * (43 - 24 * f) * (1 - f) - b.xx) * f, b.ry = b.yy + (e.yy + e.fy + Math.sin(e.ang + e.fa) * (43 - 24 * f) * (1 - f) - b.yy) * f, b.rx +=
            6 * Math.cos(b.wsp * b.gfr) * (1 - b.eaten_fr), b.ry += 6 * Math.sin(b.wsp * b.gfr) * (1 - b.eaten_fr))) : (1 != b.fr && (b.fr += b.rsp * vfr / 150, 1 <= b.fr ? (b.fr = 1, b.rad = 1) : (b.rad = .5 * (1 - Math.cos(Math.PI * b.fr)), b.rad += .66 * (.5 * (1 - Math.cos(Math.PI * b.rad)) - b.rad))), b.rx = b.xx, b.ry = b.yy, b.rx = b.xx + 6 * Math.cos(b.wsp * b.gfr), b.ry = b.yy + 6 * Math.sin(b.wsp * b.gfr));
        vfrb = vfr = 0;
        redraw();
        no_raf || raf(oef)
    },
    ...
    redraw = function() {
        ...
        if (animating) {
            ...
            var h = view_xx,
                c = view_yy;
            null != snake && (0 < fvtg && (fvtg--, fvx = fvxs[fvpos], fvy = fvys[fvpos], fvxs[fvpos] = 0, fvys[fvpos] = 0, fvpos++, fvpos >= vfc && (fvpos = 0)), view_xx = snake.xx + snake.fx + fvx, view_yy = snake.yy + snake.fy + fvy, choosing_skin && (view_xx -= 104, gsc = 1), view_ang = Math.atan2(view_yy - grd, view_xx - grd), view_dist = Math.sqrt((view_xx - grd) * (view_xx - grd) + (view_yy - grd) * (view_yy - grd)), bpx1 = view_xx - (mww2 / gsc + 84), bpy1 =
                view_yy - (mhh2 / gsc + 84), bpx2 = view_xx + (mww2 / gsc + 84), bpy2 = view_yy + (mhh2 / gsc + 84), fpx1 = view_xx - (mww2 / gsc + 24), fpy1 = view_yy - (mhh2 / gsc + 24), fpx2 = view_xx + (mww2 / gsc + 24), fpy2 = view_yy + (mhh2 / gsc + 24));
            ...
            if (high_quality || 0 < gla) {
                ...
                var w = .75;
                1 != gla && (w = 1 - .25 * gla);
                for (h = foods_c - 1; 0 <= h; h--) c = foods[h], c.rx >= fpx1 && c.ry >= fpy1 && c.rx <= fpx2 && c.ry <= fpy2 && (1 == c.rad ? (B = mww2 + gsc * (c.rx - view_xx) - c.fw2, q = mhh2 + gsc * (c.ry - view_yy) - c.fh2, -50 <= B && -50 <= q && B <= mwwp50 && q <= mhhp50 && (b.globalAlpha = w * c.fr, b.drawImage(c.fi, B, q), b.globalAlpha = f * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.fi, B, q))) : (B = mww2 + gsc * (c.rx - view_xx) -
                    c.fw2 * c.rad, q = mhh2 + gsc * (c.ry - view_yy) - c.fh2 * c.rad, -50 <= B && -50 <= q && B <= mwwp50 && q <= mhhp50 && (b.globalAlpha = w * c.fr, b.drawImage(c.fi, 0, 0, c.fw, c.fh, B, q, c.fw * c.rad, c.fh * c.rad), b.globalAlpha = f * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.fi, 0, 0, c.fw, c.fh, B, q, c.fw * c.rad, c.fh * c.rad))))
            } else
                for (h = foods_c - 1; 0 <= h; h--) c = foods[h], c.rx >= fpx1 && c.ry >= fpy1 && c.rx <= fpx2 && c.ry <= fpy2 && (1 == c.rad ? (B = mww2 + gsc * (c.rx - view_xx) - c.fw2, q = mhh2 + gsc * (c.ry - view_yy) - c.fh2, -50 <= B && -50 <= q && B <= mwwp50 && q <= mhhp50 && (b.globalAlpha = c.fr, b.drawImage(c.fi,
                    B, q))) : (B = mww2 + gsc * (c.rx - view_xx) - c.fw2 * c.rad, q = mhh2 + gsc * (c.ry - view_yy) - c.fh2 * c.rad, -50 <= B && -50 <= q && B <= mwwp50 && q <= mhhp50 && (b.globalAlpha = c.fr, b.drawImage(c.fi, 0, 0, c.fw, c.fh, B, q, c.fw * c.rad, c.fh * c.rad))));
            b.restore();
            b.save();
            b.globalCompositeOperation = "lighter";
                ...
                if (c = snakes[h], c.iiv) {
                    ...
                    if (1 == render_mode) {
                        ...
                        for (var y = c.pts.length - 1; 0 <= y; y--) {
                            ...
                            var B = e.fx,
                                q = e.fy;
                            0 < D && (px += B, py += q, lax = ax, lay = ay, ax = (px + lpx) / 2, ay = (py + lpy) / 2, z || (lax = ax, lay = ay), 1 > D && (u = 1 - D, lpx += (lax - lpx) * u, lpy += (lay - lpy) * u, ax += (lax - ax) * u, ay += (lay - ay) * u), z ? D-- : D -= c.chl + c.fchl, z ? b.quadraticCurveTo(mww2 + (lpx - view_xx) * gsc, mhh2 + (lpy - view_yy) * gsc, mww2 + (ax - view_xx) * gsc, mhh2 + (ay - view_yy) * gsc) : (b.lineTo(mww2 + (ax - view_xx) * gsc, mhh2 + (ay - view_yy) * gsc), z = !0))
                        }
                        b.save();
                        b.lineJoin = "round";
                        b.lineCap = "round";
                        is_firefox ? (c.sp > c.fsp && (y = c.alive_amt * (1 - c.dead_amt) * Math.max(0,
                            ...
                            1E4 + ")", b.stroke(), b.stroke(), b.restore()), b.globalAlpha = .4 * c.alive_amt * (1 - c.dead_amt), b.strokeStyle = "#000000", b.lineWidth = (x + 5) * gsc, b.stroke(), b.strokeStyle = c.cs, b.lineWidth = x * gsc, b.strokeStyle = "#000000", b.globalAlpha = 1 * c.alive_amt * (1 - c.dead_amt));
                        b.stroke();
                        b.strokeStyle = c.cs;
                        ...
                        b.restore();
                        b.strokeStyle = c.cs;
                        c.dead && (q = (.5 + .5 * Math.abs(Math.sin(5 * Math.PI * c.dead_amt))) * Math.sin(Math.PI * c.dead_amt), b.save(), b.lineJoin = "round", b.lineCap =
                            "round", b.globalCompositeOperation = "lighter", b.lineWidth = (x - 3) * gsc, b.globalAlpha = q, b.strokeStyle = "#FFCC99", b.stroke(), b.restore());
                        b.restore()
                    }
                    if (2 == render_mode) {
                        var x = .5 * x,
                        ...
                        H = px;
                        C = py;
                        H >= bpx1 && C >= bpy1 && H <= bpx2 && C <= bpy2 ? (pbx[0] = H, pby[0] = C, pba[0] = Math.atan2(w - (e.yy + e.fy), f - (e.xx + e.fx)) + Math.PI, pbu[0] = 1) : pbu[0] = 0;
                        B = 1;
                        n = (c.chl + c.fchl) % .25;
                        0 > n && (n += .25);
                        n = .25 - n;
                        ...
                        ax = px;
                        ay = py;
                        c.sep != c.wsep && (c.sep < c.wsep ? (c.sep += .01, c.sep >= c.wsep && (c.sep =
                            c.wsep)) : c.sep > c.wsep && (c.sep -= .01, c.sep <= c.wsep && (c.sep = c.wsep)));
                            ...
                            if (e = c.pts[y], lpx = px, lpy = py, px = e.xx + e.fx, py = e.yy + e.fy, -.25 < D) {
                                ...
                                for (u = 0; 1 > u; u += .25) {
                                    ...
                                    if (K + I < N) K += I;
                                        ...
                                        K = -K;
                                        for (F = (I -
                                                K) / N; 1 <= F; F--) K += N, pax = lax + (ax - lax) * K / I, pay = lay + (ay - lay) * K / I, pax >= bpx1 && pay >= bpy1 && pax <= bpx2 && pay <= bpy2 ? (pbx[B] = pax, pby[B] = pay, pbu[B] = 1, e = ax - lax, z = ay - lay, pba[B] = -15 <= e && -15 <= z && 15 > e && 15 > z ? at2lt[8 * z + 128 << 8 | 8 * e + 128] : -127 <= e && -127 <= z && 127 > e && 127 > z ? at2lt[z + 128 << 8 | e + 128] : Math.atan2(z, e)) : pbu[B] = 0, B++;
                                        K = I - K
                                    }
                        ...
                        if (c.tsp > c.fsp) {
                            ...
                            b.globalCompositeOperation = "lighter";
                            if (c.rbcs)
                                for (C = c.rbcs, N = C.length, y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y], e = per_color_imgs[C[y % N]], e = e.kfmc, b.save(), b.globalAlpha = D * z * .38 * (.6 + .4 * Math.cos(y / 4 - 1.15 * c.sfr)), b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.drawImage(e, -K, -K, 2 * K, 2 * K), b.restore());
                            else
                        ...
                        F *= D;
                        if (high_quality || 0 < gla)
                            for (e = F, 1 != gla && (e = F * gla), b.globalAlpha = e, y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y], b.save(), b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.drawImage(komc, -u, -u, 2 * u, 2 * u), 9 > y && (b.globalAlpha = e * (1 - y / 9), b.drawImage(ksmc, -H, -H, 2 * H, 2 * H), b.globalAlpha = e), b.restore());
                        b.globalAlpha = F;
                        if (c.rbcs) {
                            C = c.rbcs;
                            N = C.length;
                            for (y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y], 2 <= y && (u = y - 2, 1 == pbu[u] && (e = pbx[u], z = pby[u], b.save(), b.translate((e - view_xx) * gsc, (z - view_yy) * gsc), b.globalAlpha = 9 > u ? u / 9 * F : F, b.drawImage(ksmc, -H, -H, 2 * H, 2 * H), b.restore())), b.save(), b.globalAlpha = D, b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.rotate(pba[y]), u = y % (2 * q.length), u >= q.length && (u = 2 * q.length - (u + 1)), e = per_color_imgs[C[y % N]], b.drawImage(e.kmcs[u], -gsc *
                                x, -gsc * x, 2 * gsc * x, 2 * gsc * x), b.restore());
                            if (c.tsp > c.fsp && (high_quality || 0 < gla)) {
                                b.save();
                                b.globalCompositeOperation = "lighter";
                                for (y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y], b.save(), b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.rotate(pba[y]), b.globalAlpha = D * G * gla * (.5 + .5 * Math.cos(y / 4 - c.sfr)), u = y % (2 * q.length), u >= q.length && (u = 2 * q.length - (u + 1)), b.drawImage(per_color_imgs[C[y % N]].kmcs[u], -gsc * x, -gsc * x, 2 * gsc * x, 2 * gsc * x), b.restore());
                                b.restore()
                            }
                        } else {
                            for (y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y],
                                2 <= y && (u = y - 2, 1 == pbu[u] && (e = pbx[u], z = pby[u], b.save(), b.translate((e - view_xx) * gsc, (z - view_yy) * gsc), b.globalAlpha = 9 > u ? u / 9 * F : F, b.drawImage(ksmc, -H, -H, 2 * H, 2 * H), b.restore())), b.save(), b.globalAlpha = D, b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.rotate(pba[y]), u = y % (2 * q.length), u >= q.length && (u = 2 * q.length - (u + 1)), b.drawImage(q[u], -gsc * x, -gsc * x, 2 * gsc * x, 2 * gsc * x), b.restore());
                            if (c.tsp > c.fsp && (high_quality || 0 < gla)) {
                                b.save();
                                b.globalCompositeOperation = "lighter";
                                for (y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y],
                                    u = y % (2 * q.length), u >= q.length && (u = 2 * q.length - (u + 1)), b.save(), b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.rotate(pba[y]), b.globalAlpha = D * G * gla * (.5 + .5 * Math.cos(y / 4 - c.sfr)), b.drawImage(q[u], -gsc * x, -gsc * x, 2 * gsc * x, 2 * gsc * x), b.restore());
                                b.restore()
                            }
                        }
                        if (c.antenna && 2 <= B && 1 == pbu[1]) {
                            ...
                            for (y = 1; y <= fj; y++) xx = c.atx[y - 1], yy = c.aty[y - 1], xx += 2 * Math.random() - 1, yy += 2 *
                                Math.random() - 1, e = c.atx[y] - xx, z = c.aty[y] - yy, ang = -4 <= e && -4 <= z && 4 > e && 4 > z ? at2lt[32 * z + 128 << 8 | 32 * e + 128] : -8 <= e && -8 <= z && 8 > e && 8 > z ? at2lt[16 * z + 128 << 8 | 16 * e + 128] : -16 <= e && -16 <= z && 16 > e && 16 > z ? at2lt[8 * z + 128 << 8 | 8 * e + 128] : -127 <= e && -127 <= z && 127 > e && 127 > z ? at2lt[z + 128 << 8 | e + 128] : Math.atan2(z, e), xx += 4 * Math.cos(ang) * c.sc, yy += 4 * Math.sin(ang) * c.sc, c.atvx[y] += .1 * (xx - c.atx[y]), c.atvy[y] += .1 * (yy - c.aty[y]), c.atx[y] += c.atvx[y], c.aty[y] += c.atvy[y], c.atvx[y] *= .88, c.atvy[y] *= .88, e = c.atx[y] - c.atx[y - 1], z = c.aty[y] - c.aty[y - 1], I = Math.sqrt(e *
                                    e + z * z), I > 4 * c.sc && (ang = -4 <= e && -4 <= z && 4 > e && 4 > z ? at2lt[32 * z + 128 << 8 | 32 * e + 128] : -8 <= e && -8 <= z && 8 > e && 8 > z ? at2lt[16 * z + 128 << 8 | 16 * e + 128] : -16 <= e && -16 <= z && 16 > e && 16 > z ? at2lt[8 * z + 128 << 8 | 8 * e + 128] : -127 <= e && -127 <= z && 127 > e && 127 > z ? at2lt[z + 128 << 8 | e + 128] : Math.atan2(z, e), c.atx[y] = c.atx[y - 1] + 4 * Math.cos(ang) * c.sc, c.aty[y] = c.aty[y - 1] + 4 * Math.sin(ang) * c.sc);
                            b.globalAlpha = D;
                            ...
                            z = (c.aty[fj] - view_yy) * gsc;
                            b.moveTo(e, z);
                            for (y = fj - 1; 0 <= y; y--) xx = (c.atx[y] - view_xx) * gsc,
                                yy = (c.aty[y] - view_yy) * gsc, 1 <= Math.abs(xx - e) + Math.abs(yy - z) && (e = xx, z = yy, b.lineTo(e, z));
                            b.stroke();
                            ...
                            if (c.abrot) {
                                ...
                                b.drawImage(c.bulb, c.blbx * c.bsc * F, c.blby *
                                    c.bsc * F, c.blbw * c.bsc * F, c.blbh * c.bsc * F);
                                b.restore()
                        ...
                        if (c.dead) {
                            ...
                            x *= gsc;
                            for (y = B - 1; 0 <= y; y--) 1 == pbu[y] && (px = pbx[y], py = pby[y], b.save(), b.globalAlpha = q * (.6 + .4 *
                                Math.cos(y / 4 - 15 * c.dead_amt)), b.translate((px - view_xx) * gsc, (py - view_yy) * gsc), b.drawImage(kdmc, -x, -x, 2 * x, 2 * x), b.restore());
                            b.restore()
                        }
                        b.restore()
                    }
                    ...
                    q = Math.sin(E) *
                        (y + .5) + c.rey * t + Math.sin(E - Math.PI / 2) * x;
                    b.fillStyle = c.ppc;
                    b.beginPath();
                    ...
                    B = Math.cos(E) * (y + .5) + c.rex * t + Math.cos(E + Math.PI / 2) * x;
                    q = Math.sin(E) * (y + .5) +
                        c.rey * t + Math.sin(E + Math.PI / 2) * x;
                    b.fillStyle = c.ppc;
                    b.beginPath();
                    b.arc(mww2 + (B + f - view_xx) * gsc, mhh2 + (q + w - view_yy) * gsc, 3.5 * t * gsc, 0, pi2);
                    b.closePath();
            ...
            if (high_quality || 0 < gla) {
                b.save();
                b.globalCompositeOperation = "lighter";
                for (h = foods_c - 1; 0 <= h; h--) c = foods[h], c.rx >= fpx1 && c.ry >= fpy1 && c.rx <= fpx2 && c.ry <= fpy2 && (e = c.rx - view_xx, z = c.ry - view_yy, f = e * e + z * z, fs = 1 + .06 * c.rad, B = e * fs, q = z * fs, G = .005 + .09 * (1 - f / (86E3 + f)), 1 != c.rad && (G *= Math.pow(c.rad, .25)), 1 != gla && (G *= gla), B = B * gsc + mww2, q = q * gsc + mhh2, 1 ==
                    c.rad ? -150 <= B && -150 <= q && B <= mwwp150 && q <= mhhp150 && (B -= c.gfw2, q -= c.gfh2, b.globalAlpha = G * c.fr, b.drawImage(c.gfi, B, q), b.globalAlpha = G * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.gfi, B, q)) : -150 <= B && -150 <= q && B <= mwwp150 && q <= mhhp150 && (B -= c.gfw2 * c.rad, q -= c.gfh2 * c.rad, b.globalAlpha = G * c.fr, b.drawImage(c.gfi, 0, 0, c.gfw, c.gfh, B, q, c.gfw * c.rad, c.gfh * c.rad), b.globalAlpha = G * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.gfi, 0, 0, c.gfw, c.gfh, B, q, c.gfw * c.rad, c.gfh * c.rad)), fs = 1 + .32 * c.rad, B = e * fs, q = z * fs, G = .085 * (1 - f / (16500 +
                        f)), 1 != c.rad && (G *= Math.pow(c.rad, .25)), 1 != gla && (G *= gla), B = B * gsc + mww2, q = q * gsc + mhh2, 1 == c.rad ? -150 <= B && -150 <= q && B <= mwwp150 && q <= mhhp150 && (B -= c.g2fw2, q -= c.g2fh2, b.globalAlpha = G * c.fr, b.drawImage(c.g2fi, B, q), b.globalAlpha = G * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.g2fi, B, q)) : -150 <= B && -150 <= q && B <= mwwp150 && q <= mhhp150 && (B -= c.g2fw2 * c.rad, q -= c.g2fh2 * c.rad, b.globalAlpha = G * c.fr, b.drawImage(c.g2fi, 0, 0, c.g2fw, c.g2fh, B, q, c.g2fw * c.rad, c.g2fh * c.rad), b.globalAlpha = G * (.5 + .5 * Math.cos(c.gfr / 13)) * c.fr, b.drawImage(c.g2fi,
                        0, 0, c.g2fw, c.g2fh, B, q, c.g2fw * c.rad, c.g2fh * c.rad)));
                b.restore()
            }
            b.save();
            b.globalCompositeOperation = "lighter";
            for (h = preys.length - 1; 0 <= h; h--) f = preys[h], e = f.xx + f.fx, z = f.yy + f.fy, f.eaten && (c = f.eaten_by, u = Math.pow(f.eaten_fr, 2), e += (c.xx + c.fx + Math.cos(c.ang + c.fa) * (43 - 24 * u) * (1 - u) - e) * u, z += (c.yy + c.fy + Math.sin(c.ang + c.fa) * (43 - 24 * u) * (1 - u) - z) * u), e -= view_xx, z -= view_yy, c = e * e + z * z, fs = 1 + .08 * f.rad, px = e * fs, py = z * fs, G = .4 * (1 - c / (176E3 + c)), 1 != f.rad && (G *= Math.pow(f.rad, .25)), px = px * gsc + mww2, py = py * gsc + mhh2, 1 == f.rad ? -150 <= px &&
                -150 <= py && px <= mwwp150 && py <= mhhp150 && (px -= f.gfw2, py -= f.gfh2, b.globalAlpha = G * f.fr, b.drawImage(f.gfi, px, py), b.globalAlpha = G * (.5 + .5 * Math.cos(f.gfr / 13)) * f.fr, b.drawImage(f.gfi, px, py)) : -150 <= px && -150 <= py && px <= mwwp150 && py <= mhhp150 && (px -= f.gfw2 * f.rad, py -= f.gfh2 * f.rad, b.globalAlpha = G * f.fr, b.drawImage(f.gfi, 0, 0, f.gfw, f.gfh, px, py, f.gfw * f.rad, f.gfh * f.rad), b.globalAlpha = G * (.5 + .5 * Math.cos(f.gfr / 13)) * f.fr, b.drawImage(f.gfi, 0, 0, f.gfw, f.gfh, px, py, f.gfw * f.rad, f.gfh * f.rad)), fs = 1 + .32 * f.rad, px = e * fs, py = z * fs, G = .35 * (1 - c /
                    (46500 + c)), 1 != f.rad && (G *= Math.pow(f.rad, .25)), c = 2 * f.rad, px = px * gsc + mww2, py = py * gsc + mhh2, -150 <= px && -150 <= py && px <= mwwp150 && py <= mhhp150 && (px -= f.gfw2 * c, py -= f.gfh2 * c, b.globalAlpha = G * f.fr, b.drawImage(f.gfi, 0, 0, f.gfw, f.gfh, px, py, f.gfw * c, f.gfh * c), b.globalAlpha = G * (.5 + .5 * Math.cos(f.gfr / 13)) * f.fr, b.drawImage(f.gfi, 0, 0, f.gfw, f.gfh, px, py, f.gfw * c, f.gfh * c));
            b.restore();
            ...
            wumsts && 0 < rank && 0 < snake_count && playing && (wumsts = !1, c = "Your length", h = "of", G = "Your rank", "DE" == country ? (c = "Deine L\u00e4nge", h = "von", G = "Dein rang") : "FR" == country ? (c = "Votre longueur", h = "de", G = "Ton rang") : "BR" == country && (c = "Seu comprimento", h = "do", G = "Seu classifica\u00e7\u00e3o"), c = "" + ('<span style="font-size: 14px;"><span style="opacity: .4;">' + c + ': </span><span style="opacity: .8; font-weight: bold;">' + Math.floor(150 *
                (fpsls[snake.sct] + snake.fam / fmlts[snake.sct] - 1) - 50) / 10 + "</span></span>"), c += '<BR><span style="opacity: .3;">' + G + ': </span><span style="opacity: .35;">' + rank + '</span><span style="opacity: .3;"> ' + h + ' </span><span style="opacity: .35;">' + snake_count + "</span>", lbf.innerHTML = c);
            b.restore()
        }
    },
